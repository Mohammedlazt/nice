...
var config = {
  events: [
    ...
    {type: "GUILD_MEMBER_REMOVE", logType: "MEMBER_KICK", limit: 100, delay: 5000},
...
client.on('ready', () => {
   console.log(`----------------`);
      console.log(`Desert Bot-  `);
        console.log(`----------------`);
      console.log(`ON ${client.guilds.size} Servers '      ' `);
    console.log(`----------------`);
  console.log(`Logged in as ${client.user.tag}!`);
client.user.setGame(`protect Minecraft Free Accounts`,"http://twitch.tv/S-F")
